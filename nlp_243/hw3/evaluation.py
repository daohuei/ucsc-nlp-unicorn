...
if __name__ == '__main__':
    ...
    y_true = opener('hw1_tags_test.txt') if args.test else opener('hw1_labels_dev.txt')
    y_pred = opener('prediction.txt') if args.test else opener('prediction_dev.txt')
    ...
    print("Intent F1 Score is {:.2f}%".format(f1_score(y_true, y_pred,intent=True) * 100))
