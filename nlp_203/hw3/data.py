...
from config import COVID_PATH, MODEL, MAX_LEN, DOC_STRIDE
...
def prepare_dataset(dataset, prepare_type="train"):
    assert prepare_type in ["train", "eval"]
    # data tokenization
...
if __name__ == "__main__":
    dataset = load_covid_data(split="dev")
